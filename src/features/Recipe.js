...
const Recipe = () => {
  ...
  return (
    <>
      <div>
        <div className="flex flex-col border-b border-yellow">
          <h2 className="text-yellow text-8xl font-unica ml-[20px] mb-[20px] mt-[20px]">
            Currently craving...
          </h2>
          <h2 className="text-taupe text-6xl font-montserrat text-center mb-[20px] ">
          ...
          recipeSearchResults.length !== 0 ? (
            <ul className="flex flex-col items-center mt-[20px]">
              {recipeSearchResults.map((recipe, index) => (
                <li
                  key={index}
                  className="mb-[20px] font-synco text-[20px] bg-beige hover:underline decoration-4 decoration-dotted decoration-yellow"
                >
                  {recipe.title}
                </li>
              ))}
            ...
            <div className="flex flex-col mt-[50px] rounded-[10px] bg-orange-50/50 h-[400px] w-[500px] justify-center">
              <img src="./veggies.png"/>
